export const vaccinationMetadata = {
  id: 'ukraine-national-vaccination-calendar-2026',
  ...
  source: [
    {
      ...
      url: 'https://moz.gov.ua/uk/kalendar-profilaktichnih-scheplen',
    },
    {
      title: 'Наказ МОЗ України №1722 від 14.11.2025',
      url: 'https://moz.gov.ua/uk/decrees/nakaz-moz-ukrayini-vid-14-11-2025-1722-pro-zatverdzhennya-zmin-do-kalendarya-profilaktichnih-sheplen-v-ukrayini',
    },
    {
      title: 'Наказ МОЗ України №595 у чинній редакції',
      url: 'https://zakon.rada.gov.ua/laws/show/z1159-11',
    },
    {
  ...
  note:
    'Дані структуровані як довідкова підказка для лікаря. Перед клінічним рішенням перевіряйте чинну редакцію календаря та інструкцію до конкретної вакцини.',
};
