...
Вкладка «Калькулятори» показує компактні прев’ю. Одночасно розгортається лише один вибраний калькулятор. У розгорнутому стані використовується одна зовнішня рамка без дублювання назви калькулятора.
