...
Після розрахунку ниркової функції відображається довідковий блок щодо медикаментозної безпеки за категорією eGFR, CrCl і введеним калієм. Блок не призначає лікування та не містить конкретних доз.
