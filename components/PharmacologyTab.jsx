      ...
      {activeSection === 'available' ? (
        ...
        <>
          ...
          <p className="mt-5 border-t border-slate-200 pt-4 text-xs leading-5 text-slate-500">
            ...
            ВТЕ та інших станах за показаннями. Вибір класу й препарату залежить від клінічної
            ситуації, переносимості, функції нирок, електролітів, кровотеч, взаємодій та супутньої
            терапії.
          </p>
        </>
      )}
