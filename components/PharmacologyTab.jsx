  ...
  return (
    <div>
      ...
      <p className="mt-5 border-t border-slate-200 pt-4 text-xs leading-5 text-slate-500">
        БРА / сартани, ІАПФ і блокатори кальцієвих каналів застосовуються за відповідними
        показаннями. Вибір класу й препарату залежить від клінічної ситуації, переносимості,
        функції нирок, калію та супутньої терапії.
      </p>
    </div>
  );
}
