...
const protectionClasses = [
  ...
  },
  {
    id: 'statins',
    title: 'Статини',
    use: 'Зниження серцево-судинного ризику при ХХН з урахуванням віку, ліпідного профілю та наявності атеросклеротичного ССЗ.',
    mechanism:
      'Знижують рівень ЛПНЩ і ризик інфаркту, ішемічного інсульту та інших атеросклеротичних подій.',
    tip:
      'Не відновлюють eGFR і не є прямим лікуванням ниркової недостатності. Вибір препарату та дози залежить від серцево-судинного ризику, взаємодій і категорії ХХН.',
  },
];
