...
const questions = [
  'Почуття нервозності, тривоги або напруженості.',
  'Нездатність зупинити чи контролювати хвилювання.',
  'Надмірне переживання хвилювання щодо різних речей.',
  'Проблеми з розслабленням.',
  'Сильний неспокій аж до неможливості всидіти на місці.',
  'Легкий перехід до збудження і дратівливості.',
  'Відчуття страху, ніби може статися щось жахливе.',
];

const options = [
  { value: 0, label: 'Зовсім не турбували' },
  { value: 1, label: 'Декілька днів турбували' },
  { value: 2, label: 'Понад тиждень турбували' },
  { value: 3, label: 'Майже щодня турбували' },
];
