    ...
    <aside className="space-y-4 xl:sticky xl:top-4">
      <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <button type="button" onClick={() => printReportDocument({ title: 'ПРОТОКОЛ ЕХОКАРДІОГРАФІЇ', overview, conclusion, recommendations })} className="rounded-md border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 transition hover:border-blue-200 hover:text-blue-700">
            Друк / PDF
          </button>
      ...
      <ReportPrintArea
        title="ПРОТОКОЛ ЕХОКАРДІОГРАФІЇ"
        overview={overview}
