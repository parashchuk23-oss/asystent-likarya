...
export default function NeckVesselsReportPreview({
  overview,
  conclusion,
  recommendations,
  onOverviewChange,
    ...
    <aside className="space-y-4 lg:sticky lg:top-4">
      <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <button type="button" onClick={() => printReportDocument({ title: 'ПРОТОКОЛ УЗД СУДИН ШИЇ', overview, conclusion, recommendations })} className="rounded-md border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 transition hover:border-blue-200 hover:text-blue-700">
            Друк / PDF
          </button>
